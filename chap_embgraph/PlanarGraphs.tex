...
\begin{examplefigureenv}{191figures/plangraph_4colors.tikz}
...
\centering
\begin{tikzpicture}
\draw (0,-2) -- (-1,-1) -- (0,0) -- (0,-2) -- (1,-1) -- (2,0) -- (1,1) -- (0,0) -- (2,0);
\draw (0,0) -- (1,-1);
\draw[fill=red] (0,0) circle[radius=.2];
\draw[fill=green] (0,-2) circle[radius=.2];
\draw [fill=blue](1,1) circle[radius=.2];
\draw [fill=green](2,0) circle[radius=.2];
\draw[fill=blue] (1,-1) circle[radius=.2];
\draw[fill=yellow] (-1,-1) circle[radius=.2];
\draw  plot[smooth, tension=.7] coordinates {(5.5,-0.5) (6,0.5) (7,1)};
\draw  plot[smooth, tension=.7] coordinates {(5.5,-0.5) (6.5,0) (7,1)};
\draw  plot[smooth, tension=.7] coordinates {(7,-2) (5.5,-0.5)};
\draw  plot[smooth, tension=.7] coordinates {(7,-2) (7,1)};
\draw  plot[smooth, tension=.7] coordinates {(8.5,-0.5) (7.5,0) (7,1)};
\draw  plot[smooth, tension=.7] coordinates {(8.5,-0.5) (8,0.5) (7,1)};
\draw (5.5,-0.5) -- (8.5,-0.5);
\draw[fill=yellow] (7,-2) circle[radius=.2];
\draw[fill=blue] (8.5,-0.5) circle[radius=.2];
\draw[fill=red] (5.5,-0.5) circle[radius=.2];
\draw[fill=green] (7,1) circle[radius=.2];
\node at (0.5,-3) {$G$};
\node at (7,-3) {$K_G$};
\end{tikzpicture}
\caption{A non-optimal coloring of $G$, and the associated coloring multigraph $K_G$.}
\label{fig:nonoptimalcolor}
\end{figure}
In fact, we can improve our local result on coloring by 1. 

\begin{theorem}[\cite{brooks1941colouring}]
 Let $G$ be a connected graph which is not an odd cycle or a complete graph. Then $\gamma(G)\leq \Delta(G)$. \label{thm:brooks}
\end{theorem}
\begin{proof}
...
\includegraphics[width=4cm]{191figures/topgraph_colordegree2.tikz}}
\textfigure[6cm]{\textbf{Ease Case:} For any $i, j, k$, the paths we've constructed from $v_i$ to $v_j$ and from $v_j$ to $v_k$ may only intersect at $v_j$. Any other intersection point $w$ would have two neighbors colored $i$, and two neighbors colored $k$, and could therefore be colored some other 4th color}{ \includegraphics[width=4cm]{191figures/topgraph_colordegree3.tikz}}
...
\node at (5.5,0) {$v$};
\node at (5,1.5) {$v_{(1)}$};
\node at (6.5,-1) {$v_2$};\draw[fill=green] (4,2) circle[radius=.2];
\draw[fill=blue] (4,-2) circle[radius=.2];
\draw[fill=red] (3,0) circle[radius=.2];
\draw[fill=red] (6,-2) circle[radius=.2];
\draw[fill=red] (5,1) circle[radius=.2];
\draw[fill=blue] (6,-1) circle[radius=.2];
\draw[fill=green] (4,-1) circle[radius=.2];
\draw[fill=green] (5,-3) circle[radius=.2];
\draw[fill=green] (-5,-3) circle[radius=.2];
\draw[fill=red] (-6,2) circle[radius=.2];
\draw[fill=blue] (-6,-2) circle[radius=.2];
\draw[fill=green] (-7,0) circle[radius=.2];
\draw[fill=red] (-4,-2) circle[radius=.2];
\draw[fill=green] (-5,1) circle[radius=.2];
\draw[fill=blue] (-4,-1) circle[radius=.2];
\draw[fill=red] (-6,-1) circle[radius=.2];
\draw (-5,0) circle[radius=.2];
\end{tikzpicture}
...
\begin{itemize}
 ...
 \item Local structure does not give us a good pin on chromaticity. Take for instance this theorem of Erd\"os:
\end{itemize}
...
In order to prove this, Erd\"os used a technique called the probabilistic method. \project This technique allows you prove the existence of certain combinatorial object by arguing that the probability of them existing in a randomly generated combinatorial object is non-zero. In this case, Erd\"os 
...
\end{theorem}
Interestingly, the roots of chromatic polynomials do not give us all of the algebraic numbers. For instance,\project \label{proj:chromatic} $\phi+1$ may never be the root of a chromatic polynomial. However, the set of all roots of chromatic polynomials is dense in $C$. The properties of roots chromatic polynomials is still not completely understood. \\
...
\draw (11,2.5) -- (11.5,1);
\draw (10,-1) -- (11.5,-3);
\draw[fill=red] (10,-1) circle[radius=.2];
\draw[fill=red] (11.5,-3) circle[radius=.2];
\draw[fill=blue] (11,2.5) circle[radius=.2];
\draw[fill=blue] (15.5,1) circle[radius=.2];
\draw[fill=blue] (14.5,1) circle[radius=.2];
\draw[fill=blue] (13,1) circle[radius=.2];
\draw[fill=blue] (11.5,1) circle[radius=.2];
\draw[fill=blue] (10,1) circle[radius=.2];
\draw[fill=blue] (8.5,1) circle[radius=.2];
\draw[fill=red] (14.5,-1) circle[radius=.2];
\draw[fill=red] (13,-1) circle[radius=.2];
\draw[fill=red] (11.5,-1) circle[radius=.2];
\draw[fill=red] (8.5,-1) circle[radius=.2];
\end{tikzpicture}
...
\draw[fill=green] (0,1) circle[radius=.2];
\draw[fill=red] (-2,-3) circle[radius=.2];
\draw[fill=yellow] (0,-3) circle[radius=.2];
\draw[fill=blue] (-2,-1) circle[radius=.2];
\draw[fill=orange] (2,-1) circle[radius=.2];
...
\draw[fill=green] (3,-3) circle[radius=.2];
\draw[fill=yellow] (3,1) circle[radius=.2];
\draw[fill=blue] (2,2) circle[radius=.2];
\draw[fill=orange] (-2,2) circle[radius=.2];
...
\draw[fill=red]  (8.5,-2) circle[radius=.1];
\draw[fill=blue]  (8.5,-1) circle[radius=.1];
\draw[fill=blue]  (9,-1.5) circle[radius=.1];
\draw[fill=blue]  (9.5,-1) circle[radius=.1];
\draw[fill=red]  (9.5,1.5) circle[radius=.1];
\draw[fill=red]  (8,3) circle[radius=.1];
\draw[fill=blue] (5.5,2.5) circle[radius=.1];
\draw[fill=blue]  (5,-0.5) circle[radius=.1];
\draw[fill=blue]  (5,-1.5) circle[radius=.1];
\draw[fill=blue]  (5.5,-1.5) circle[radius=.1];
\draw[fill=blue]  (5.5,-1) circle[radius=.1];
\draw[fill=blue]  (4.5,-0.5) circle[radius=.1];
\draw[fill=red]  (8.5,-2.5) circle[radius=.1];
\draw[fill=red]  (8,-2) circle[radius=.1];
\end{tikzpicture}
